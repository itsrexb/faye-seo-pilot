...
final class ContentListPage {
	...
	public function register(): void {
		$this->hook = add_submenu_page(
			...
			__( 'Content Queue', 'seo-pilot-pro-to-faye-seo-pilot' ),
			__( 'Content Queue', 'seo-pilot-pro-to-faye-seo-pilot' ),
			'edit_posts',
	...
	public function render(): void {
		...
		<div class="wrap seopilot-wrap">
			<h1><?php esc_html_e( 'Content Queue', 'seo-pilot-pro-to-faye-seo-pilot' ); ?></h1>
			<p class="seopilot-subtitle"><?php esc_html_e( 'Select posts or pages to audit with Claude. Changes require your approval before being saved.', 'seo-pilot-pro-to-faye-seo-pilot' ); ?></p>

			<form method="get" class="seopilot-filter-form">
				<input type="hidden" name="page" value="faye-seo-pilot-queue" />
				<select name="post_type">
					<option value="any" <?php selected( $post_type, 'any' ); ?>><?php esc_html_e( 'All types', 'seo-pilot-pro-to-faye-seo-pilot' ); ?></option>
					<option value="post" <?php selected( $post_type, 'post' ); ?>><?php esc_html_e( 'Posts', 'seo-pilot-pro-to-faye-seo-pilot' ); ?></option>
					<option value="page" <?php selected( $post_type, 'page' ); ?>><?php esc_html_e( 'Pages', 'seo-pilot-pro-to-faye-seo-pilot' ); ?></option>
				</select>
				<input type="search" name="s" value="<?php echo esc_attr( $search ); ?>" placeholder="<?php esc_attr_e( 'Search…', 'seo-pilot-pro-to-faye-seo-pilot' ); ?>" />
				<?php submit_button( __( 'Filter', 'seo-pilot-pro-to-faye-seo-pilot' ), 'secondary', '', false ); ?>
			</form>
			...
			<table class="wp-list-table widefat fixed striped seopilot-table">
				<thead>
					<tr>
						...
						<th><?php esc_html_e( 'Title', 'seo-pilot-pro-to-faye-seo-pilot' ); ?></th>
						<th><?php esc_html_e( 'Type', 'seo-pilot-pro-to-faye-seo-pilot' ); ?></th>
						<th><?php esc_html_e( 'Status', 'seo-pilot-pro-to-faye-seo-pilot' ); ?></th>
						<th><?php esc_html_e( 'Words', 'seo-pilot-pro-to-faye-seo-pilot' ); ?></th>
						<th><?php esc_html_e( 'Modified', 'seo-pilot-pro-to-faye-seo-pilot' ); ?></th>
						<th><?php esc_html_e( 'Last Audit', 'seo-pilot-pro-to-faye-seo-pilot' ); ?></th>
						<th><?php esc_html_e( 'Actions', 'seo-pilot-pro-to-faye-seo-pilot' ); ?></th>
					</tr>
				</thead>
				<tbody>
					<?php if ( empty( $posts ) ) : ?>
						<tr><td colspan="8"><?php esc_html_e( 'No posts found.', 'seo-pilot-pro-to-faye-seo-pilot' ); ?></td></tr>
					<?php else : ?>
						<?php foreach ( $posts as $post ) : ?>
							...
							<tr data-post-id="<?php echo esc_attr( (string) $post->ID ); ?>">
								...
								<td>
									<strong>
										<a href="<?php echo esc_url( (string) $edit_url ); ?>"><?php echo esc_html( $post->post_title ?: __( '(no title)', 'seo-pilot-pro-to-faye-seo-pilot' ) ); ?></a>
									</strong>
								</td>
								...
								<td>
									...
									<?php else : ?>
										<span class="seopilot-status seopilot-status--none"><?php esc_html_e( 'Never', 'seo-pilot-pro-to-faye-seo-pilot' ); ?></span>
									<?php endif; ?>
								</td>
								<td>
									<button
									...
									><?php esc_html_e( 'Audit', 'seo-pilot-pro-to-faye-seo-pilot' ); ?></button>
									<?php if ( $last_job && in_array( $last_job->status, [ 'audited', 'in_review', 'partially_approved' ], true ) ) : ?>
										<a
											...
											class="button"
										><?php esc_html_e( 'Review', 'seo-pilot-pro-to-faye-seo-pilot' ); ?></a>
									<?php endif; ?>
								</td>
							</tr>
						<?php endforeach; ?>
			...
			<div class="seopilot-bulk-bar">
				<button id="seopilot-bulk-audit" class="button button-primary" disabled>
					<?php esc_html_e( 'Audit Selected', 'seo-pilot-pro-to-faye-seo-pilot' ); ?>
				</button>
